...
for(var i = 0; i < bitcoinTransaction.data.length; i++){
  //["2015-08-05",78910198.0]
  //if(bitcoinYear.hasOwnProperty( bitcoinTransaction.data[i][0].substr(0,4) ) ){

    bitcoinYear[ bitcoinTransaction.data[i][0].substr(0,4) ] = i;
